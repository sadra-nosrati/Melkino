  ...
  return (
    <>
      ...
      <div className="flex w-full min-h-screen bg-dark-background-secondary">
        ...
        <header className="laptop:hidden fixed inset-x-0 top-0 z-1000 flex h-14 items-center border-b border-theme-strong/5 bg-dark-background/90 px-4 backdrop-blur-xl">
          <button
            onClick={() => setOpen((prev) => !prev)}
            className="flex h-10 w-10 items-center justify-center rounded-xl text-dark-primary transition-all duration-300 hover:bg-theme-strong/5"
          >
            {open ? (
