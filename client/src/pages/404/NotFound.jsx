    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-dark-background px-6">
      ...
      <section className="relative z-10 flex max-w-2xl flex-col items-center text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          ...
          <button
            onClick={() => navigate(-1)}
            className="cursor-pointer rounded-xl border border-dark-border-strong px-6 py-3 text-theme-light transition-all duration-300 hover:border-dark-primary hover:text-dark-primary"
          >
            صفحه قبل
          </button>
        </div>
