...
export const showLogoutModal = (onConfirm) => {
  Swal.fire({
    html: `
      ...
      <h2 class="text-theme-strong text-lg font-medium mt-4">
        خروج از حساب کاربری
      </h2>

      <p class="mt-2 text-sm text-theme-soft">
    ...
    ...modalTheme,
    customClass: {
      popup: "!rounded-2xl !p-6 !border !border-dark-border",
      confirmButton:
        "!bg-dark-primary !text-dark-background-secondary !rounded-xl !px-6",
      cancelButton:
        "!bg-theme-strong/5 !text-theme-soft !rounded-xl !px-6",
    },
    didOpen: () => {
