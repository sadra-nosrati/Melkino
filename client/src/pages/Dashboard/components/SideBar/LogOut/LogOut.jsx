...
function LogOut({ onNavigate }) {
  ...
  return (
    <button
      onClick={handleClick}
      className="group flex w-full items-center justify-between rounded-xl px-4 py-3 text-theme-soft hover:bg-theme-strong/5 hover:text-dark-primary transition-all cursor-pointer"
    >
      <span>خروج</span>
