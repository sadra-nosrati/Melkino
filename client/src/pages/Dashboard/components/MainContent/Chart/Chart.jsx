        ...
        <BarChart data={data} margin={{ top: 20, right: 10, left: -10 }}>
          ...
          <Tooltip
            ...
            content={({ active, payload, label }) => {
              ...
              return (
                <div className="rounded-xl border border-dark-primary/20 bg-dark-card-hover px-4 py-2 text-sm text-theme-strong shadow-lg">
          ...
          <Bar
            ...
            activeBar={{ fill: "var(--theme-primary)" }}
          />
        </BarChart>
      </ResponsiveContainer>
    </div>
