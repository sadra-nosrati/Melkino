...
function Support() {
  return (
    <article className="group rounded-3xl border border-theme-strong/5 bg-theme-strong/2 p-4 tablet-portrait:p-6 transition-all duration-300 hover:border-dark-primary/20 mt-10 laptop:mt-30">
      <div className="flex flex-col mobile-landscape:flex-row items-start mobile-landscape:items-center gap-3 mobile-landscape:gap-5">
        ...
        <h3 className="text-base tablet-portrait:text-lg font-semibold text-theme-strong">
          مشاوره اختصاصی
        </h3>
      </div>

      <p className="mt-3 text-xs tablet-portrait:text-sm leading-6 tablet-portrait:leading-7 text-theme-faint">
