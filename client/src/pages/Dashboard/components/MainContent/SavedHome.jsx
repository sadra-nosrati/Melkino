  ...
  return (
    <div className="w-full laptop:w-[65%]">
      <header className="flex items-center justify-between">
        <h2 className="text-xl tablet-portrait:text-2xl text-theme-light">
          املاک ذخیره شده
        </h2>

        <Link
          to="/dashboard/favorites"
          className="text-sm tablet-portrait:text-base text-theme-light hover:text-dark-primary transition-colors"
        >
          مشاهده همه
        </Link>
      </header>
