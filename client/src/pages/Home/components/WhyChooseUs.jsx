  ...
  return (
    <div className="mx-auto max-w-7xl px-4 mobile:px-6">
      <div className="mx-auto mb-10 tablet-portrait:mb-16 max-w-2xl text-center">
        <h2 className="mb-4 text-3xl tablet-portrait:text-4xl font-extrabold text-theme-strong">
          چرا ملکینو؟
        </h2>

        <p className="text-sm tablet-portrait:text-base leading-7 tablet-portrait:leading-8 text-theme-soft">
      ...
      <div className="grid grid-cols-1 mobile-landscape:grid-cols-2 tablet-landscape:grid-cols-3 gap-5 tablet-portrait:gap-6">
        {items.map((item, i) => {
          ...
          return (
            <article
              key={i}
              className="group relative overflow-hidden rounded-3xl border border-theme-strong/10 bg-theme-feature-card p-6 tablet-portrait:p-8 transition-all duration-300 hover:-translate-y-2 hover:border-dark-primary-active/40 hover:shadow-[0_0_40px_rgba(212,175,55,0.08)]"
            >
              ...
              <h3 className="mb-3 tablet-portrait:mb-4 text-lg tablet-portrait:text-xl font-bold text-theme-strong">
                {item.title}
              </h3>
